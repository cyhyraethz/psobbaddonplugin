...
OPTIONAL_LABEL_ARG(format, "%.3f")
OPTIONAL_ENUM_ARG(extra_flags, 0)
CALL_FUNCTION(InputFloat2, bool, label, v, format, extra_flags)
PUSH_BOOL(ret)
END_FLOAT_ARRAY2(v)
PUSH_LAST_BOOL(ret)
END_IMGUI_FUNC
...
OPTIONAL_LABEL_ARG(format, "%.3f")
OPTIONAL_ENUM_ARG(extra_flags, 0)
CALL_FUNCTION(InputFloat3, bool, label, v, format, extra_flags)
PUSH_BOOL(ret)
END_FLOAT_ARRAY3(v)
PUSH_LAST_BOOL(ret)
END_IMGUI_FUNC
...
OPTIONAL_LABEL_ARG(format, "%.3f")
OPTIONAL_ENUM_ARG(extra_flags, 0)
CALL_FUNCTION(InputFloat4, bool, label, v, format, extra_flags)
PUSH_BOOL(ret)
END_FLOAT_ARRAY4(v)
PUSH_LAST_BOOL(ret)
END_IMGUI_FUNC
